  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal
      .titulo-principal__numero
        span 1
      h1 Estado y estructura de servicio
      ...
      .bloque-texto-a.color-secundario.p-4.p-md-5.mb-5 
        .row.m-0.align-items-center.justify-content-between
          .col-lg-4.mb-4.mb-lg-0
            figure
              img(src='@/assets/curso/t1/f2.png' alt='imagen de personaje antiguo')
          .col-lg-8
            .bloque-texto-a__texto.p-4
              p Así entonces, la evolución de las civilizaciones, su capacidad asociativa y por ende de desarrollo, hizo que se hicieran organizaciones cada vez más complejas, que debían definir nuevos roles, actuaciones, acceso y reconocimiento al poder y defensa de los recursos, porque una organización que tuviera buenas condiciones (recursos cualesquiera que fuere), era objeto de ataques, lo que con el tiempo configuró los primeros modelos de los libros de constitución. Es sin duda este el origen de lo que se denomina en la historia “Estado”, donde se pasó de simples organizaciones sociales a organizaciones mucho más complejas que denotaban aspectos propiamente políticos, en su relación con sus integrantes y en su relación con otros estados.

    #t_1_1.titulo-segundo
      h2 1.1 Definición de Estado
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-md-8
              .bloque-texto-f.color-primario.pt-4.px-5
                ...
                h4.text-regular.bloque-texto-f__texto.text-center Es una sociedad humana asentada de manera permanente en el territorio que le corresponde, sujeta a un poder soberano que crea, define y aplica un orden jurídico que estructura la sociedad estatal para obtener el bien público temporal de sus componentes.
                .bloque-texto-f__autor.mb-3
                  h3.mb-0.text-center Platón (s.f)
          .row.justify-content-center.align-items-center
            .col-md-3.mb-4.mb-md-0
              figure
            ...
            .col-md-8
              .bloque-texto-f.color-primario.pt-4.px-5
                .bloque-texto-f__comillas
                  i.fas.fa-quote-left
                  i.fas.fa-quote-right
                h4.text-regular.bloque-texto-f__texto.text-center Es una agrupación humana fijada en un territorio determinado y en la que existe un orden social, político y jurídico orientado hacia un bien común, establecido y mantenido por una autoridad dotada de poder de coerción.
                .bloque-texto-f__autor.mb-3
                  h3.mb-0.text-center André Hauriou- Jurista Francés (s.f)
          .row.justify-content-center.align-items-center
            .col-md-3.mb-4.mb-md-0
              figure
            ...
            .col-md-8
              .bloque-texto-f.color-primario.pt-4.px-5
                .bloque-texto-f__comillas
                  i.fas.fa-quote-left
                  i.fas.fa-quote-right
                h4.text-regular.bloque-texto-f__texto.text-center La asociación perfecta de hombres libres unidos para gozar de sus derechos y para la utilidad común. Es la asociación política soberana que dispone de un territorio propio, con una organización específica y un supremo poder facultado para crear el derecho positivo.
                .bloque-texto-f__autor.mb-3
                  h3.mb-0.text-center H. Grocio (s.f)
          .row.justify-content-center.align-items-center
            .col-md-3.mb-4.mb-md-0
              figure
            ...
            .col-md-8
              .bloque-texto-f.color-primario.pt-4.px-5
                .bloque-texto-f__comillas
                  i.fas.fa-quote-left
                  i.fas.fa-quote-right
                h4.text-regular.bloque-texto-f__texto.text-center El Estado “Una comunidad organizada en territorio definido, mediante un orden jurídico servido por un cuerpo de funcionarios y definido y organizado por un poder jurídico, autónomo y centralizado que tiende a realizar el bien común, en el ámbito de esa comunidad”
                .bloque-texto-f__autor.mb-3
                  h3.mb-0.text-center Sánchez Agesta. (s.f)
          .row.justify-content-center.align-items-center
            .col-md-3.mb-4.mb-md-0
              figure
            ...
            .col-md-8
              .bloque-texto-f.color-primario.pt-4.px-5
                .bloque-texto-f__comillas
                  i.fas.fa-quote-left
                  i.fas.fa-quote-right
                h4.text-regular.bloque-texto-f__texto.text-center Colombia es un Estado social de derecho, organizado en forma de República unitaria, descentralizada, con autonomía de sus entidades territoriales, democrática, participativa y pluralista, fundada en el respeto de la dignidad humana, en el trabajo y la solidaridad de las personas que la integran y en la prevalencia del interés general”.
                .bloque-texto-f__autor.mb-3
                  h3.mb-0.text-center Constitución Política de Colombia (1991)
    ...
    #t_1_2.titulo-segundo
      h2 1.2 Estructura y servicios

    p.mb-5 Colombia como Estado soberano reconocido internacionalmente, para efectos de su funcionamiento y operación estableció su estructura vigente en la constitución de 1991 (Figura 2): 

    .titulo-sexto.color-acento-contenido
      span Estructura del Estado
    ...
    #RamasDelPoder.row.align-items-center.p-5.bg3.mb-5
      ...
      .col-lg-2
        a(@click="gotoElement('ejecutivo')")
          figure
            img(src='@/assets/curso/t1/f12.svg' alt='').noHover
            img(src='@/assets/curso/t1/f12h.svg' alt='').hover
      .col-lg-2
        a(@click="gotoElement('legislativo')")
          figure
            img(src='@/assets/curso/t1/f13.svg' alt='').noHover
            img(src='@/assets/curso/t1/f13h.svg' alt='').hover
      .col-lg-2
        a(@click="gotoElement('judicial')")
          figure
    ...
    #ejecutivo.row.p-5
      ...
      .col-lg-7
        h4.cp Ejecutivo
        p Está representado con el poder para la toma de decisiones administrativas propias del gobierno temporal que en el caso de Colombia es de cuatro años, que permitan el cumplimiento de la constitución y las leyes, en pro de garantizar los derechos y libertades de los ciudadanos, así como de la preservación del territorio y los diferentes recursos que posee el Estado.
        .cajon.color-acento-contenido.p-4.mb-4
          p.mb-0 Está en cabeza de la presidencia y vicepresidencia de la república como instituciones garantes de ejecución y cumplimiento, donde el vicepresidente tendrá la obligación de sustituir al presidente en ausencia o delegación expresa.
        p La actuación administrativa es coordinada por el gobierno a través de sus ministros de cartera, los directores de departamentos administrativos de manera centralizada y descentralizada, lo cual define actuaciones por ende nacionales, departamentales y municipales.
      .col-lg-1.floatRight
        a(@click="gotoElement('RamasDelPoder')").mx-auto
          img(src='@/assets/curso/t1/flechitaUp.svg').w28px
    p Las organizaciones que contribuyen al presidente en la administración del Estado definiendo el gobierno en sí son: 

    .row.mb-5
      .col-lg-8
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
          div(titulo="Ministerios")
            p Son el conjunto de organizaciones gubernamentales del poder ejecutivo, encargados de la formulación de políticas, programas, planes y proyectos acordes al plan de gobierno del presidente, que velan por el desarrollo sostenible de la sociedad. (Rama Ejecutiva - Orden Nacional - Manual del Estado - Función Pública. s.f). 
            p Estas instituciones se clasifican por asuntos de cartera o áreas de función de gobierno, entre las que se encuentran: Ministerio del Interior, Ministerio de Relaciones Exteriores, Ministerio de Hacienda y Crédito Público, Ministerio de Justicia y del Derecho, Ministerio de Defensa Nacional, Ministerio de Agricultura y Desarrollo Rural, Ministerio de Salud y Protección Social, Ministerio de Trabajo, Ministerio de Minas y Energía, Ministerio de Comercio, Industria y Turismo, Ministerio de Educación Nacional, Ministerio de Ambiente y Desarrollo Sostenible, Ministerio de Vivienda, Ciudad y Territorio, Ministerio de Tecnologías de la Información y las Comunicaciones, Ministerio de Transporte, Ministerio de Cultura, Ministerio de Ciencia, Tecnología e Innovación, Ministerio del Deporte. (Rama Ejecutiva - Orden Nacional - Manual del Estado - Función Pública. s.f). 
          div(titulo="Departamentos Administrativos")
            p Departamento Administrativo de la Presidencia de la República, Departamento Nacional de Planeación (DNP), Departamento Administrativo de la Función Pública, Departamento Administrativo para la Prosperidad Social, Dirección Nacional de Inteligencia, Departamento Administrativo Nacional de Estadística (DANE). (Rama Ejecutiva - Orden Nacional - Manual del Estado - Función Pública. s.f). 
          div(titulo="Consejos superiores de Administración")
            p Consejo Superior de Política Fiscal (CONFIS), Consejo Superior de la Carrera Registral, Consejo Superior de la Carrera Notarial, Consejo Superior de Política Criminal, Consejo de Seguridad Nacional, Consejo Superior de Salud de las Fuerzas Militares y la Policía Nacional, Consejo Superior de la Administración de Restitución de Tierras, Consejo Superior de Comercio Exterior, Consejo Superior de Micro Empresa y de la Pequeña y Mediana Empresa, Consejo Superior de Turismo. (Rama Ejecutiva - Orden Nacional - Manual del Estado - Función Pública. s.f).  
          div(titulo="Unidades Administrativas Especiales")
            p Agencia del Inspector General de Tributos, Rentas y Contribuciones Parafiscales (ITRC), Unidad de Proyección Normativa y Estudios de Regulación Financiera (URF), Unidad de Planificación de Tierras Rurales, adecuación de Tierras y Usos Agropecuarios (UPRA), Comisión de Regulación de Energía, Gas y Combustibles (CREG), Parques Nacionales Naturales de Colombia, Autoridad Nacional de Licencias Ambientales (ANLA), Comisión de Regulación de Agua Potable y Saneamiento Básico (CRA), Comisión de Regulación de Comunicaciones (CRC). (Rama Ejecutiva - Orden Nacional - Manual del Estado - Función Pública. s.f). 
      .col-lg-4
        figure
    ...
    #legislativo.row.p-5.contenedor.bg3-5
      ...
      .col-lg-7
        h4.cp Legislativo
        p Al conjunto de estos organismos les corresponde hacer la formulación de las leyes y proponer proyectos normativos para garantizar los derechos de todos los ciudadanos y de la preservación de los recursos del Estado. Promueve los cambios a la constitución, ejerce el control político de las acciones del gobierno y sus organismos del poder ejecutivo y elige los altos funcionarios de la rama judicial, aprobar las contrataciones y desarrollo de proyectos por actuaciones de comisiones. El conjunto de organizaciones de esta rama de poder es bicameral, un alta y una baja:
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
          div(titulo="Senado (cámara alta)")
            p Conformada por 108 curules de las cuales, 100 corresponden a elección por circunscripción nacional, 5 curules para el partido FARC (Fuerza Alternativa Revolucionaria del Común), 2 curules de especial votación para los movimientos indígenas, 1 curul reservada para el 2do puesto en elecciones presidenciales, en reconocimiento del estatuto de oposición.
          div(titulo="Cámara de representantes (cámara baja)")
            p Conformada por 172 curules de las cuales, 161 corresponden a elección por circunscripción nacional, 5 curules para el partido FARC (Fuerza Alternativa Revolucionaria del Común), 1 curul de especial votación para los movimientos indígenas, 2 curules reservadas de especial votación para las comunidades afro, 1 curul de especial votación para las comunidades raizales, 1 curul para los residentes colombianos en el exterior, 1 curul reservada para el 2do puesto en elecciones presidenciales, en reconocimiento del estatuto de oposición.
      .col-lg-1.floatRight
        a(@click="gotoElement('RamasDelPoder')").mx-auto
          img(src='@/assets/curso/t1/flechitaUp.svg').w28px
    ...
    #judicial.row.p-5.contenedor
      ...
      .col-lg-7
        h4.cp Judicial
        p Se encarga de vigilar y hacer cumplir las leyes, vela por la protección de los derechos de los colombianos y decide frente a las personas o instituciones que no cumplen o impiden dichos derechos, lo que implica que sus funcionarios guarden principio de favorabilidad ante la restitución de los derechos de los ciudadanos. Dentro del conjunto de instituciones que pertenecen a esta rama de poder se encuentran:
      .col-lg-1.floatRight
        a(@click="gotoElement('RamasDelPoder')").mx-auto
          img(src='@/assets/curso/t1/flechitaUp.svg').w28px
    TabsC.color-acento-contenido.mb-5
      .py-3.py-md-4.fcb(titulo="Corte Suprema de Justicia")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f19.svg' alt='')
          .col-md-7
      ...
      .py-3.py-md-4.fcb(titulo="Consejo de Estado")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f20.svg' alt='')
          .col-md-7
      ...
      .py-3.py-md-4.fcb(titulo="Corte Constitucional")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f21.svg' alt='')
          .col-md-7
      ...
      .py-3.py-md-4.fcb(titulo="Consejo Superior de la Judicatura")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f22.svg' alt='')
          .col-md-7
      ...
      .py-3.py-md-4.fcb(titulo="Jurisdicciones Especiales")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f23.svg' alt='')
          .col-md-7
      ...
      .py-3.py-md-4.fcb(titulo="Fiscalía General de la Nación")
        .row.align-items-center.justify-content-center
          .col-md-3
            figure
              img(src='@/assets/curso/t1/f24.svg' alt='')
          .col-md-7
    ...
    #organismosDelEstado.row.align-items-center.p-5.bg3.mb-5.justify-content-center
      ...
      .col-lg-2
        a(@click="gotoElement('control')")
          figure
            img(src='@/assets/curso/t1/f25.svg' alt='').noHover
            img(src='@/assets/curso/t1/f25h.svg' alt='').hover
      .col-lg-2
        a(@click="gotoElement('electoral')")
          figure
            img(src='@/assets/curso/t1/f26.svg' alt='').noHover
            img(src='@/assets/curso/t1/f26h.svg' alt='').hover
      .col-lg-2
        a(@click="gotoElement('independientes')")
          figure
    ...
    .col-lg-10.mx-auto.mb-5
      .bloque-texto-a.color-primario.p-4.p-md-5.mb-5 
        .row.m-0.align-items-center.justify-content-between
          .col-lg-4.mb-4.mb-lg-0
            figure
              img(src='@/assets/curso/t1/f44-b.svg' alt='Persona con un megafono')
          .col-lg-8
            .bloque-texto-a__texto.p-4
              p.mb-4 De manera complementaria y ampliada, en el siguiente enlace se puede observar la composición general estructural del conjunto de organismos que configuran el Estado desde lo dispuesto en la constitución Política de Colombia:
              a.anexo.mb-4.mb-lg-0(href="https://www.funcionpublica.gov.co/eva/gestornormativo/manual-estado/index.php" target="_blank")
                .anexo__icono
                  img(src="@/assets/template/icono-link.svg")
                .anexo__texto
                  p https://www.funcionpublica.gov.co/eva/gestornormativo/manual-estado/index.php 
    Separador
    #t_1_3.titulo-segundo
      h2 1.3 Entidades públicas
      ...
      .tarjeta.bg2.mb-5.boxShadow
        SlyderA.p-5
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Entidad pública
              p Obedece a organizaciones pertenecientes al Estado y administradas generalmente por el gobierno, pueden ser empresas en participación donde el Estado tiene la mayoría accionaria y por ende un poder dominante en la gestión, su creación se motiva por la ausencia de un bien o servicio o de brindarlos a la población en condición de vulnerabilidad o donde no se goza de dichos beneficios ofrecidos. Tienen personería jurídica, patrimonio y régimen propio, su ejercicio no necesariamente debe generar gasto, sino que pueden generar beneficios que entran según su participación, al tesoro y Fisco Nacional; lo que depende de la naturaleza y objetivo de la entidad pública de que se trate.
            .col-lg-4
              figure
                img(src='@/assets/curso/t1/f45.svg' alt='imagen relacionada')
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Misión
              p Expresa el propósito fundamental de la entidad o su razón de ser, el objeto social para el cual fue creada la entidad, indicando para quién está dirigido este propósito y donde se presta el servicio fundamental (a nivel nacional, departamental o municipal).
            .col-lg-4
              figure
          ...
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Visión
              p Es una proyección sistémica de las operaciones de la entidad pública, que busca facilitar la toma de decisiones estratégicas en pro del mejoramiento continuo y del bienestar de quienes serán usuarios o beneficiarios de la entidad, es una mirada objetiva de largo plazo de cómo desean que se reconozcan los servicios o impactos de la entidad por parte de los ciudadanos.
            .col-lg-4
              figure
                img(src='@/assets/curso/t1/f48.svg' alt='imagen relacionada')
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Funciones
              p Las funciones públicas son todas las actividades desarrolladas y ejercidas por las instituciones y organizaciones del Estado, para el cumplimiento de sus propósitos fundamentales o misionales para las cuales fueron creadas. El servicio público es una actividad que desarrolla la administración de cada institución de manera directa o indirecta por delegación, con el fin de cumplir con el objeto social o de satisfacer las necesidades de los usuarios, con un enfoque de interés general hacia la comunidad, y por las cuales debe velar su cumplimiento. Deben ser explícitas desde cada institución o servicio prestado, de tal manera que los usuarios puedan solicitar servicios y que facilite el control de quienes ejercen el mando, así como dar cumplimiento a los dispuesto en la norma que regula la operación y funcionamiento de la entidad.
            .col-lg-4
              figure
                img(src='@/assets/curso/t1/f49.svg' alt='imagen relacionada')
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Portafolio de servicios
              p Es la declaración a la comunidad en general o a grupos de interés sobre el conjunto de productos o servicios que brinda la institución, definiendo sus características, alcances, limitaciones y demás detalles de cada oferta a brindar, que permitan a la sociedad acceder a dichos productos o servicios; los cuales deben estar disponibles y ser ofertados por diversos medios en lo posible, y expuestos en un lenguaje claro y entendible a cualquier usuario.
            .col-lg-4
              figure
                img(src='@/assets/curso/t1/f50.svg' alt='imagen relacionada')
          .row.justify-content-center.align-items-center
            .col-lg-7
              h4 Normatividad en las entidades públicas
              p Es un conjunto de leyes, decretos, resoluciones y reglamentos en sí, que parametrizan los procedimientos y definen las conductas que se deben tener frente a los usuarios y empleados, en pro de cumplir los propósitos misionales y funcionales de las instituciones u organización estatales o públicas. Cada institución pública regularmente obedece a una normativa que la crea y faculta para la prestación de su servicio fundamental, y cuenta con instrumentos complementarios (leyes, decretos, resoluciones), para su operación y funcionamiento, así como se rige de los demás instrumentos de normatividad transversales a las instituciones estatales, públicas o de gobierno, bien sean del orden nacional, departamental o municipal.
            .col-lg-4
              figure
                img(src='@/assets/curso/t1/f51.svg' alt='imagen relacionada')

    p.mb-5 Ahora bien, el Estado colombiano y las entidades públicas se interrelacionan de acuerdo a los entes de control para un servicio de calidad en un marco de atención:
    .col-lg-8.mb-5.mx-auto
      .titulo-sexto.color-acento-contenido
        span Interrelación Estado colombiano y entidades públicas
      img(src='@/assets/curso/t1/f52.svg' alt='imagen relacionada')

    Separador
    #t_1_4.titulo-segundo
      h2 1.4 Funcionarios públicos
    p.mb-5 La Constitución Nacional de 1991 en su Artículo 123, define que son servidores públicos los miembros de las corporaciones públicas, los empleados y trabajadores del Estado y de sus entidades descentralizadas territorialmente y por servicios, por tanto, lo podemos caracterizar como se describe a continuación: 
    ...
    #t_1_5.titulo-segundo
      h2 1.5 Política y Programa Nacional de Servicio al Ciudadano
    ...
    .contenedor.bg5
      .row.align-items-center.mb-5
        ...
        .col-lg-3
          figure
            img(src='@/assets/curso/t1/f55.png' alt='imagen relacionada')
    ...
    #t_1_6.titulo-segundo
      h2 1.6 Normas de calidad: ISO 9000, NTC GP 1000
    
    .row.align-items-center.mb-4
      .col-lg-7
        .cajon-b.color-secundario.p-4
          p.mb-0 La NTC GP 1000, es la sigla de la Norma Técnica de Calidad de la Gestión Pública, y el documento que especifica los requisitos de implementación para un Sistema de Calidad en la Gestión, aplicable y que sea ajustable a todas las entidades gubernamentales, estatales o con funciones públicas. El propósito fundamental de esta norma se centra en promover que las entidades mejoren la calidad y el desempeño de los servicios y productos ofrecidos a la ciudadanía. Es una herramienta de gestión que permite dirigir y evaluar el desempeño institucional en términos de calidad y satisfacción social. 
        .cajon-c.color-acento-contenido.p-4
          p.mb-0 En el sentido normativo, de acuerdo a los establecido en el artículo 6 de la Ley 872 de 2003, la NTC GP 1000 emplea como base las normas internacionales ISO 9000:2005 y la ISO 9001:2008 sobre la gestión de calidad, sin embargo, en términos generales, la norma también integra requisitos y conceptos adicionales a los del estándar ISO.
      .col-lg-5
        figure
          img(src='@/assets/curso/t1/f65.png' alt='imagen relacionada')

    .row.align-items-center.mb-5
      .col-lg-4
        figure
          img(src='@/assets/curso/t1/f66.png' alt='imagen relacionada')
      .col-lg-8
        p Es importante tener en cuenta que la NTC GP 1000 pasó a ser parte del Modelo Integrado de Planeación y Gestión (MIPG) con el Decreto 1499 de 2017, por ello se deben tener en cuenta los lineamientos que presenta el MIPG como instrumento que asegura, estandariza y mejora la calidad de los procesos en las instituciones donde se aplica, dando un certero proceso de servicio y atención al ciudadano.
        p La fundamentación de la NTC GP 1000 como es convencional en las normas ISO, busca transformar y disciplinar las prácticas, en este caso, la gestión de las organizaciones públicas, en un sistema basado en procesos, promueve y no meramente por funciones y verticalidades burocráticas. Busca determinar y gestionar series de actividades relacionadas entre sí hasta su producto o entregable. La ventaja de este enfoque es que facilita tener un control y trazabilidad y hacer continuas las operaciones individuales y de procesos de la entidad cómo un todo.  El enfoque permite entender el funcionamiento de la institución como un conjunto de mecanismos articulados mejorando la dinámica y las sinergias entre actividades relacionadas facilitando a su vez el mejoramiento continuo.
    ...
    p.mb-5 Las ventajas en la gestión institucional permiten: mejorar la comprensión y el cumplimiento de los requisitos de los ciudadanos, considerar los procesos como generadores de valor social o económico, obtener resultados de desempeño y eficacia fácilmente, proponer mejora continua de los procesos tomando como referencia las mediciones o métricas de actuación.
    .col-lg-6.mb-5.mx-auto
      .titulo-sexto.color-acento-contenido
    ...
    .row.align-items-center
      .col-lg-7
        p La implementación de esta norma NTC GP 1000-2009 es de carácter obligatorio para todas las entidades públicas, la certificación deberá emitirse por medio de una agencia certificadora independiente nacional o extranjera, con representación en el país, quien validará los requisitos en conformidad del sistema de gestión implementado en la institución a certificar.
        .cajon.color-acento-contenido.p-4
          p.mb-0 Cabe mencionar que su compatibilidad con otros sistemas como el de control interno y de gestión administrativa facilita los procesos de certificación y de mejora continua, por ende, de atención al ciudadano.
      .col-lg-5
        figure
          img(src='@/assets/curso/t1/f69.png' alt='')
